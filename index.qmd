...
modern methods for _causal mediation analysis_.
...
version `r quarto::quarto_version()`. See the `renv.lock` file accompanying the
repository for up-to-date list of packages used.
...
#| label: renv-restore
#| eval: false
# * Project '<PATH/TO>/causal_mediation_workshops' loaded. [renv 1.0.7]
